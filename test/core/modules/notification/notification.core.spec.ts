...
import { NotificationMapper } from 'src-clean/core/modules/notification/mappers/notification.mapper';
import { NotificationDTO } from 'src-clean/core/modules/notification/DTOs/notification.dto';

// Simple test for core notification functionality
describe('Notification Core Tests', () => {
  ...
  describe('Notification Mapper', () => {
    ...
    it('should map DTO to entity', () => {
      ...
      // Check if destinationToken is a value object or string
      if (typeof notification!.destinationToken === 'string') {
        expect(notification!.destinationToken).toBe('test@example.com');
      } else {
        expect(notification!.destinationToken.toString()).toBe(
          'test@example.com',
        );
      }
