...
export class CreateTablesOrderAndOrderItem1748141873865 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "customer_id" uuid, "status" character varying NOT NULL, "total_price" numeric(10,2) NOT NULL, "store_id" uuid NOT NULL, "totem_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
